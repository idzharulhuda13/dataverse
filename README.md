...
| 🏢 **Enterprise Warehouse** | Instantly load predefined data from local DuckDB or Cloud BigQuery environments. |
| 🗄️ **SQL Agent** | Specialist that writes and executes structured SQL for massive datasets in DuckDB/BigQuery. |
